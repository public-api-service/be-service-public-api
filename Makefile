...
build:
	...
	# rm saksi/delivery/grpc/customer/*
	# mkdir -p saksi/delivery/grpc/customer
	# protoc --go_out=saksi/delivery/grpc/customer --go_opt=paths=source_relative --go-grpc_out=saksi/delivery/grpc/customer --go-grpc_opt=paths=source_relative --proto_path=saksi/delivery/grpc/proto grpc.proto
